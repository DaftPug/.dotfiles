...
globalkeys = my_table.join(
    ...
    awful.key({ modkey  }, "æ", function () awful.util.spawn("sh /home/puggi/.scripts/,1440psolo.sh") end,
      {description = "1440p solo", group = "super"}),
    awful.key({ modkey  }, "ø", function () awful.util.spawn("sh /home/puggi/.scripts/,laptopsolo.sh") end, {description = "Laptop solo", group = "super"}),
    awful.key({ modkey  }, "å", function () awful.util.spawn("sh /home/puggi/.scripts/,bothon.sh") end,
      {description = "Both on", group = "super"}),



    -- super + shift + ...
    awful.key({ modkey, "Shift"   }, "Return", function() awful.util.spawn( filemanager ) end),
    awful.key({ modkey, "Shift"   }, "æ", function() awful.util.spawn( "sh /home/puggi/.scripts/,soundrs.sh" ) end),
